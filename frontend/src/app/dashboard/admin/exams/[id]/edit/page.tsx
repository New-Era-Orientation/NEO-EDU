...
import { api, type ExamQuestion, type Exam } from "@/lib/api";
...
export default function EditExamPage({ params }: EditExamPageProps) {
    ...
    useEffect(() => {
        const fetchExam = async () => {
            try {
                setIsLoading(true);
                const data = await api.getExamWithQuestions(id);
                setExam(data.exam);
                setFormData({
                    ...
                    max_attempts: data.exam.max_attempts,
                    shuffle_questions: data.exam.shuffle_questions,
                    is_published: data.exam.is_published,
                });
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Update exam details and questions</p>
                </div>
            </div>
